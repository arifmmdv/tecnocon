                    ...
                    <div class="tp-caption tp-resizeme"
                        ...
                        <div class="btns-box">
                            @if(!empty($slide->button_text))
                                <a href="{{$slide->button_link}}" class="theme-btn btn-style-one">{{$slide->button_text}}</a>
                            @endif
                            @if(!empty($slide->button_text_2))
                                    <a href="{{$slide->button_link_2}}" class="theme-btn btn-style-two">{{$slide->button_text_2}}</a>
                            @endif
                        </div>
                    </div>
                    @endif
